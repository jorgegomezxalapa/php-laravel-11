                ...
                <div class="card-body">
                   <div class="card">
                    <div class="card-header">
                        Número y nombre de la obra
                    </div>
                    <div class="card-body">
                        <p>Objeto de la obra</p>
                        <img src="https://constructorainsur.com/wp-content/uploads/2022/11/img_obracivil-161.jpg" class="img-fluid" alt="...">
                        <button class="btn btn-primary">
                            Ver detalle de la obra
                        </button>
                        <button class="btn btn-secondary">
                            Generar ficha de la obra
                        </button>
                    </div>
                   </div>
                    <form action="{{ route("obras.store") }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" name="numero_obra" id="numero_obra" min="100" max="999" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="nombre_obra" id="nombre_obra" maxlength="100" required>
                        </div>
                
                        <!-- Clave de obra -->
                        <div class="mb-3">
                            <label for="clave_obra" class="form-label">Clave de Obra</label>
                            <input type="text" class="form-control" name="clave_obra" id="clave_obra" pattern="^GT2025-[A-Z]{3}/\d{2}$" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="objeto_obra" id="objeto_obra" rows="3" required></textarea>
                        </div>

                    ...
                    <div class="card-body">
                        <form action="{{ route('incidentes.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{ @$incidente->tipo_incidente }}" class="form-control" id="tipo_incidente" name="tipo_incidente"
                                    required>
                                </select>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" value="{{ @$incidente->fecha_incidente }}" class="form-control" id="fecha_incidente" name="fecha_incidente"
                                    required>
                            </div>
                            <button type="submit"

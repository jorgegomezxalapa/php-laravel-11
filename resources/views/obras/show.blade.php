    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-12">
                ...
                <input type="hidden" name="latitud_hidden" id="latitud_hidden" value="{{ @$obra->latitud }}">
                <input type="hidden" name="longitud_hidden" id="longitud_hidden" value="{{ @$obra->longitud }}">

...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12">
                <h4>Registro de obra</h4>
            </div>
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <form id="form-obras" action="{{ route('obras.store') }}" method="POST" novalidate>
                            @csrf
                            ...
                            <div class="d-flex justify-content-end">
                                <button type="submit" class="btn btn-primary">{{ @$obra ? 'Editar' : 'Guardar' }} Obra</button>
                            </div>
                        </form>
                    </div>
                </div>
